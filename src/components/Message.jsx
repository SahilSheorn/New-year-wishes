...
const message = [
    ...
    'As we celebrate the new year, let cherish the bonds that make our families special. May the coming year strengthen these ties and bring us closer together. Happy New ',
    ...
    return (
        <>
            ...
            <div className='next_btn'>
                ...
                <button className='btnn' onClick={refreshPage}>Next Greetings➡</button>
            </div>
        </>
    );
}
